...
[Read in English](README_EN.md) · [📝 6月知乎连载:从零开始 Qwen 3.6 35B-A3B 写专用推理引擎踩坑心得分享](https://zhuanlan.zhihu.com/p/2045562329396400486) · [战略文档](docs/STRATEGY.md) · [架构设计](docs/DESIGN.md) · **[🆕 6/3 Restart Notes](RELEASE_NOTES_20260603.md)** · [P1 dense projection PoC](reports/stage6/P1_DENSE_PROJECTION_POC_20260604.md) · [P1-A tiled sweep](reports/stage6/P1A_TILED_PROJECTION_SWEEP_20260604.md) · [P2 grouped MoE census](reports/stage6/P2_GROUPED_MOE_PREFILL_CENSUS_20260604.md) · [P2-E scheduler retune](reports/stage6/P2E_SCHEDULER_ACTIVE_RETUNE_20260604.md) · [5/20 历史 Release Notes](RELEASE_NOTES_20260520.md)
...
- **P2-A/B/C/D/E 证据:** 单 expert gate/up 输 BF16;routed active path M64=23.83ms/layer;P2-D 加回 router/shared 后 M64=29.21ms/layer,0.741x vs BF16;P2-E sort scheduler + `block_inter=8` 把 M64 拉到 20.25ms/layer,1.057x vs BF16 full MoE。
- **下一关:** P2-F opt-in 一层替换;dense/MoE M>1 若要追平并超过 BF16,最终要 native FP4-MMA/CUTLASS-style bridge。
