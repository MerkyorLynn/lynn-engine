...
[Read in English](README_EN.md) · [📝 6月知乎连载:从零开始 Qwen 3.6 35B-A3B 写专用推理引擎踩坑心得分享](https://zhuanlan.zhihu.com/p/2045562329396400486) · [战略文档](docs/STRATEGY.md) · [架构设计](docs/DESIGN.md) · **[🆕 6/3 Restart Notes](RELEASE_NOTES_20260603.md)** · [P1 dense projection PoC](reports/stage6/P1_DENSE_PROJECTION_POC_20260604.md) · [P1-A tiled sweep](reports/stage6/P1A_TILED_PROJECTION_SWEEP_20260604.md) · [P2 grouped MoE census](reports/stage6/P2_GROUPED_MOE_PREFILL_CENSUS_20260604.md) · [P2-F opt-in replacement](reports/stage6/P2F_ONE_LAYER_REPLACEMENT_VERIFY_20260604.md) · [5/20 历史 Release Notes](RELEASE_NOTES_20260520.md)
...
- **P2-A/B/C/D/E/F 证据:** 单 expert gate/up 输 BF16;routed active path M64=23.83ms/layer;P2-D M64=29.21ms/layer;P2-E harness M64=20.25ms/layer;P2-F engine opt-in mode M64=20.23ms/layer,1.043x vs BF16 full MoE,24.96x vs `stream_bf16`,peak 0.643GiB。
- **下一关:** P2-G 多层 no-reload smoke;dense/MoE M>1 若要追平并超过 BF16,最终要 native FP4-MMA/CUTLASS-style bridge。
