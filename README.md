...
- **下一关:** P3-B/P3-C/P3-D Spark artifacts;P3-D 只 bank opt-in server smoke,默认 promotion 与完整 RC 仍需后续质量电池。dense/MoE M>1 若要追平并超过 BF16,最终要 native FP4-MMA/CUTLASS-style bridge。
