...
| **R6000 / FP4-MMA** | census 已 bank:**RTX PRO 6000 96GB / 880GiB data workspace** PASS,CUDA capability `[12,0]`,vLLM source candidates **200**,P76/P79/P85/P87/P103 native FP4 contracts 全过。**R5-C0/R5-C1/R5-C2A 已过:**CUTLASS/CuTe 暴露 sm120 `mxf4nvf4` block16 E2M1 + UE4M3 scale ABI;CUTLASS 79d native NVF4+UE4M3 grouped GEMM host-reference numeric smoke PASS;MoE shape census 证明需把 92-style `MoEProblemShape/tokens_per_expert` 语义接到 79d-style SM120 执行。只 bank ABI/numeric smoke/source-census,不 bank selected-expert kernel/speed/default。 |
...
| **E. native kernels / FP4-MMA** | grouped CUDA C++/CUTLASS kernels + FP4-MMA 硅兑现 | R5-C2A MoE shape census 已 banked;下一步写新最小 R5-C2 selected expert gate/up harness,仍不宣称 grouped-MoE speed/default |
...
92 有 MoE shape 语义但走 Sm100 schedule。下一步是写新最小 R5-C2 selected expert gate/up harness,
