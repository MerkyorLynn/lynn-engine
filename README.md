...
- **下一关:** P3-B selected-prefill Spark artifact;P3-C/P3-D 才是 server/RC promotion。dense/MoE M>1 若要追平并超过 BF16,最终要 native FP4-MMA/CUTLASS-style bridge。
