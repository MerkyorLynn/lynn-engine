...
| **P3 contract** | P3-A layer0 grouped active-MoE contract probe 已过:numeric true,shadow absent at candidate start,argmax **3/3**,packed active bytes **0.563 GiB** vs BF16 active **1.500 GiB**,但 speed **0.744×** vs BF16 active;只 bank contract,不 bank fused kernel。 |
