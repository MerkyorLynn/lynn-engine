...
| **E. native kernels / FP4-MMA** | grouped CUDA C++/CUTLASS kernels + FP4-MMA 硅兑现 | R5-C2C real D-row slot scatter smoke 已 banked;下一步 R5-C3 grouped active-MoE prefill POC 或 in-epilogue selected-output scatter,仍不宣称 grouped-MoE speed/default |
