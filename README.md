...
- **P2-A/B/C/D/E/F/G 证据:** 单 expert gate/up 输 BF16;routed active path M64=23.83ms/layer;P2-F engine opt-in mode M64=20.23ms/layer;P2-G 4 层 residual-scale smoke M64=80.97ms,1.051x vs BF16,30.04x vs `stream_bf16`,peak 2.527GiB,numeric pass。
- **下一关:** P2-H full prefill selected-layer smoke;dense/MoE M>1 若要追平并超过 BF16,最终要 native FP4-MMA/CUTLASS-style bridge。
