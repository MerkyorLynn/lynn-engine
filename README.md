...
[Read in English](README_EN.md) · [📝 6月知乎连载:从零开始 Qwen 3.6 35B-A3B 写专用推理引擎踩坑心得分享](https://zhuanlan.zhihu.com/p/2045562329396400486) · [战略文档](docs/STRATEGY.md) · [架构设计](docs/DESIGN.md) · **[🆕 6/3 Restart Notes](RELEASE_NOTES_20260603.md)** · [P1 dense projection PoC](reports/stage6/P1_DENSE_PROJECTION_POC_20260604.md) · [P1-A batched projection result](reports/stage6/P1A_BATCHED_PROJECTION_POC_20260604.md) · [5/20 历史 Release Notes](RELEASE_NOTES_20260520.md)
...
- **P1-A 初版反证:** naive batched bridge numeric/no-shadow 过,但 M>1 性能失败;下一版必须做 tiled packed projection kernel。
- **下一关:** P1-A tiled batched/M>1 packed projections,随后 P2 grouped MoE packed-prefill kernels。
