...
| **Packed prefill** | P0.1/P0.2 passed:no-reload `stream_bf16` is token-exact, peak **40.28 GiB**, proof prefill **20.75s**; after-release BF16 resident is **4.72 GiB**. |
...
| **Native zero-shadow MoE** | P4B numeric reference is exact, but single-CTA and active recompute were rejected by microbench; P4C active-reuse runtime bridge + speed baseline + component profile + tile2 server smoke are banked. |
| **Current bottleneck** | P4C profile pins gate/up at **151.67us (63.8%)**; shape sweep found `tile_inter=2,threads=128`: **91.41us = 1.659×**; full-path P4C candidate passed: **267.32→185.09us = 1.444×**, output/scratch exact. |
| **Runtime opt-in** | `LYNN_NATIVE_GATEUP_TILE_INTER=2` passed real resident-runner preflight + OpenAI server smoke: P4C native call delta **240**, 40 layers called, completion text-exact **2/2**, release/reload healthy, recorded tile=2. |

**Honest boundary:** Spark sm_121 currently delivers **~44-45 TPS** decode; P4C only banks route/numeric/baseline/diagnostic, an opt-in shape candidate, and server smoke, **not fused speed/default promotion**. The next gate is tile2 RC quality + sustained server TPS. Python stays as the control/verification plane; catching llama.cpp requires native kernels, and the full payoff lands on FP4-MMA silicon.
...
[阅读中文版](README.md) · [Chinese Zhihu June series: Qwen 3.6 35B-A3B custom inference engine](https://zhuanlan.zhihu.com/p/2045562329396400486) · [Strategy](docs/STRATEGY.md) · [Architecture](docs/DESIGN.md) · **[🆕 6/3 Restart Notes](RELEASE_NOTES_20260603.md)** · [Stage 6 evidence ledger](reports/stage6/STAGE6_EVIDENCE_LEDGER_20260604.md) · [P1 dense projection PoC](reports/stage6/P1_DENSE_PROJECTION_POC_20260604.md) · [P1-A tiled sweep](reports/stage6/P1A_TILED_PROJECTION_SWEEP_20260604.md) · [P2 grouped MoE census](reports/stage6/P2_GROUPED_MOE_PREFILL_CENSUS_20260604.md) · [P2-G multi-layer MoE smoke](reports/stage6/P2G_MULTILAYER_MOE_SMOKE_20260604.md) · [P2-H selected-layer prefill smoke](reports/stage6/P2H_SELECTED_LAYER_PREFILL_SMOKE_20260604.md) · [P2-I selected-MoE expansion](reports/stage6/P2I_SELECTED_MOE_EXPANSION_SMOKE_20260604.md) · [P2-J linear-attn trace](reports/stage6/P2J_LINEAR_ATTN_PREFILL_TRACE_20260604.md) · [P2-KA gated-delta loop PoC](reports/stage6/P2KA_GATED_DELTA_NATIVE_LOOP_POC_20260604.md) · [P2-KB block kernel PoC](reports/stage6/P2KB_GATED_DELTA_BLOCK_KERNEL_POC_20260604.md) · [P2-L linear-attn integration](reports/stage6/P2L_LINEAR_ATTN_BLOCK_INTEGRATION_SMOKE_20260604.md) · [P2-M selected-layer smoke](reports/stage6/P2M_SELECTED_LAYER_BLOCK_LINEAR_SMOKE_20260604.md) · [P2-N wider-layer smoke](reports/stage6/P2N_WIDER_LAYER_BLOCK_LINEAR_SMOKE_20260604.md) · [P2-O RC runbook](reports/stage6/P2O_PACKED_PREFILL_RC_GATE_RUNBOOK_20260604.md) · [P3 grouped-MoE contract](reports/stage6/P3_GROUPED_MOE_ZERO_SHADOW_CONTRACT_20260604.md) · [P3-B selected-prefill gate](reports/stage6/P3B_SELECTED_PREFILL_GATE_RUNBOOK_20260604.md) · [P3-C resident-prompt gate](reports/stage6/P3C_RESIDENT_PROMPT_GATE_RUNBOOK_20260604.md) · [P3-D server smoke gate](reports/stage6/P3D_SERVER_RC_PROMOTION_GATE_RUNBOOK_20260604.md) · [P3-E RC quality battery](reports/stage6/P3E_RC_QUALITY_BATTERY_RUNBOOK_20260604.md) · [P4 native zero-shadow ABI](reports/stage6/P4_NATIVE_FUSED_MOE_ABI_CONTRACT_20260604.md) · [P4B fused single-kernel contract](reports/stage6/P4B_NATIVE_FUSED_SINGLE_KERNEL_CONTRACT_20260604.md) · [P4C active-reuse decision](reports/stage6/P4C_ACTIVE_REUSE_KERNEL_DECISION_20260604.md) · [P4C speed baseline](reports/stage6/p4c_active_reuse_microbench_20260604_104254/summary.md) · [P4C component profile](reports/stage6/p4c_component_profile_20260604_105640/summary.md) · [P4C gate/up sweep](reports/stage6/p4c_gateup_shape_sweep_20260604_111603/summary.md) · [P4C shape candidate](reports/stage6/p4c_gateup_shape_candidate_20260604_112635/summary.md) · [P4C tile2 server smoke](reports/stage6/p4c_tile2_server_smoke_20260604_122443/summary.md) · [Stage 6 GPU gate suite](reports/stage6/STAGE6_GPU_GATE_SUITE_RUNBOOK_20260604.md) · [5/20 historical notes](RELEASE_NOTES_20260520.md)
...
- **Next gate:** P2-O/P3-B/P3-C/P3-D/P3-E Spark artifacts; P3-D banks opt-in server smoke only and P3-E banks RC quality smoke only, while default promotion and full leaderboard quality still require the follow-up release battery. P4B native zero-shadow has banked fail-loud route integrity plus a single-CTA output-returning numeric reference plus two microbench anti-proofs (single-CTA serial is slow; multi-CTA active recompute is slower). **The P4C active-reuse runtime bridge plus speed baseline plus component profile plus gate/up shape sweep plus full-path candidate plus tile=2 resident-runner preflight plus OpenAI server smoke are banked:** `fused_zero_shadow_active_reuse_contract` passes on the Spark real-runner path; the speed baseline records **1.00013x** vs P4A with exact output/scratch; component profile shows gate/up is the **63.8%** main cost and down is **36.2%**; shape sweep found `tile_inter=2,threads=128` at **91.41us = 1.659x**; full-path candidate proves P4C **267.32→185.09us = 1.444x**; real-runner `LYNN_NATIVE_GATEUP_TILE_INTER=2` route/numeric passes; server smoke records P4C call delta **240**, **40** layers called, text-exact **2/2**, release/reload healthy. Fused speed/default promotion remain closed; the next cut is tile2 RC quality + sustained server TPS. Dense/MoE M>1 needs a native FP4-MMA/CUTLASS-style bridge to catch and surpass BF16.
