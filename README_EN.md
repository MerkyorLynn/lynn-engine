...
| **R6000 / FP4-MMA** | Census is banked:**RTX PRO 6000 96GB / 880GiB data workspace** PASS, CUDA capability `[12,0]`, vLLM source candidates **200**, and P76/P79/P85/P87/P103 native FP4 contracts all pass. **R5-C0 passed:** CUTLASS/CuTe exposes an sm120 `mxf4nvf4` block16 E2M1 + UE4M3 scale ABI; ABI only, no grouped-MoE kernel/speed/default bank. |
...
| **E. native kernels / FP4-MMA** | Grouped CUDA C++/CUTLASS kernels plus FP4-MMA silicon payoff | R5-C0 CUTLASS UE4M3 ABI is banked; next is R5-C1 minimal numeric GEMM smoke, still no grouped-MoE speed/default claim |
...
The next gate is R5-C1 minimal numeric GEMM smoke, not a grouped-MoE FP4-MMA
kernel or default speed promotion claim.
