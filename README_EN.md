...
- **P2-A/B/C/D/E/F/G/H evidence:** single-expert gate/up loses to BF16; routed active path reaches M64=23.83ms/layer; P2-F engine opt-in mode M64=20.23ms/layer; P2-G 4-layer residual-scale MoE smoke M64=80.97ms; P2-H mixed L0-3 full prefill T16=45.97ms, 1.274x vs BF16, 52.09x vs `stream_bf16`, peak 2.606GiB, numeric pass.
- **Next gate:** P2-I selected-MoE expansion + P2-J linear-attn prefill trace; dense/MoE M>1 needs a native FP4-MMA/CUTLASS-style bridge to catch and surpass BF16.
