...
[阅读中文版](README.md) · [Chinese Zhihu June series: Qwen 3.6 35B-A3B custom inference engine](https://zhuanlan.zhihu.com/p/2045562329396400486) · [Strategy](docs/STRATEGY.md) · [Architecture](docs/DESIGN.md) · **[🆕 6/3 Restart Notes](RELEASE_NOTES_20260603.md)** · [P1 dense projection PoC](reports/stage6/P1_DENSE_PROJECTION_POC_20260604.md) · [P1-A tiled sweep](reports/stage6/P1A_TILED_PROJECTION_SWEEP_20260604.md) · [P2 grouped MoE census](reports/stage6/P2_GROUPED_MOE_PREFILL_CENSUS_20260604.md) · [P2-F opt-in replacement](reports/stage6/P2F_ONE_LAYER_REPLACEMENT_VERIFY_20260604.md) · [5/20 historical notes](RELEASE_NOTES_20260520.md)
...
- **P2-A/B/C/D/E/F evidence:** single-expert gate/up loses to BF16; routed active path reaches M64=23.83ms/layer; P2-D M64=29.21ms/layer; P2-E harness M64=20.25ms/layer; P2-F engine opt-in mode M64=20.23ms/layer, 1.043x vs BF16 full MoE, 24.96x vs `stream_bf16`, peak 0.643GiB.
- **Next gate:** P2-G multi-layer no-reload smoke; dense/MoE M>1 needs a native FP4-MMA/CUTLASS-style bridge to catch and surpass BF16.
