...
- **P2-A/B/C/D/E/F/G/H/I/J evidence:** single-expert gate/up loses to BF16; routed active path reaches M64=23.83ms/layer; P2-F engine opt-in mode M64=20.23ms/layer; P2-H/P2-I selected full prefill keeps numeric/no-shadow/speed passing; P2-J trace shows `chunk_gated_delta_with_state` is 71-76% of linear-attn prefill traced wall.
- **Next gate:** P2-K gated-delta prefill kernel PoC; dense/MoE M>1 needs a native FP4-MMA/CUTLASS-style bridge to catch and surpass BF16.
