...
- **P2-A/B/C/D/E/F/G evidence:** single-expert gate/up loses to BF16; routed active path reaches M64=23.83ms/layer; P2-F engine opt-in mode M64=20.23ms/layer; P2-G 4-layer residual-scale smoke M64=80.97ms, 1.051x vs BF16, 30.04x vs `stream_bf16`, peak 2.527GiB, numeric pass.
- **Next gate:** P2-H full prefill selected-layer smoke; dense/MoE M>1 needs a native FP4-MMA/CUTLASS-style bridge to catch and surpass BF16.
