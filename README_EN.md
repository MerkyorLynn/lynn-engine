...
| **E. native kernels / FP4-MMA** | Grouped CUDA C++/CUTLASS kernels plus FP4-MMA silicon payoff | R5-C2C real D-row slot scatter smoke is banked; next is R5-C3 grouped active-MoE prefill POC or in-epilogue selected-output scatter, still no grouped-MoE speed/default claim |
