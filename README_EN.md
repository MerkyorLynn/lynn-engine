...
| **R6000 / FP4-MMA** | Bring-up/census tooling is ready, waiting for a RTX PRO 6000 96GB PASS artifact; preferred rental is **723 host with 943GB expansion**. The gate checks CUDA/PyTorch/disk, vLLM Marlin-Machete/CUTLASS visibility, and P76/P79/P85/P87/P103 native FP4 contracts. |
...
| **E. native kernels / FP4-MMA** | Grouped CUDA C++/CUTLASS kernels plus FP4-MMA silicon payoff | R6000 census gate is ready; run the RTX PRO 6000 96GB host first, then start the grouped-MoE FP4-MMA POC |
