...
- **Next gate:** P3-B/P3-C/P3-D Spark artifacts; P3-D banks opt-in server smoke only, while default promotion and full RC still require the follow-up quality battery. Dense/MoE M>1 needs a native FP4-MMA/CUTLASS-style bridge to catch and surpass BF16.
