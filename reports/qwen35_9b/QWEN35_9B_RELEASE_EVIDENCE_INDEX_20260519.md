...
**Branch:** `main` (integrated from `claude/qwen35-9b-release-evidence-index-20260519`)
...
| Quality: GPQA Diamond (thinking-on) | **IN PROGRESS** — latest live 94/198: 72.3% naive, 81.9% excl parse fail | `reports/qwen35_9b/p201_gpqa_live_summary_20260519_live_210912.md` |
...
| `reports/qwen35_9b/QWEN35_9B_RELEASE_QA_STATUS_20260519.md` | QA checklist (72 tracked items in current collector) |
...
2. **32K thinking-on GPQA is not final.** The eval is live on R6000; latest archived partial is 94/198 and must not be treated as the final number.
...
5. **35B A3B is not part of the 9B release.** It remains a separate research/performance track.
