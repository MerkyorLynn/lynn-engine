...
| Field | Value |
|---|---|
| Result | `/root/autodl-tmp/src/lynn-engine-r5c2c-codex/reports/stage6/r5c2c_real_d_row_slot_scatter_smoke_20260604_201440/result.json` |
...
| Benchmark file | `/root/autodl-tmp/src/lynn-engine-r5c2c-codex/reports/stage6/r5c2c_real_d_row_slot_scatter_smoke_20260604_201440/result.benchmark.txt` |
| D-row digest file | `/root/autodl-tmp/src/lynn-engine-r5c2c-codex/reports/stage6/r5c2c_real_d_row_slot_scatter_smoke_20260604_201440/result.d_row_digest.jsonl` |
...
| Avg runtime ms (trace only) | `[0.028256, 0.017408]` |
...
|---|---:|---|---:|---:|---:|
| `cooperative` | `256` | `[32, 64, 64, 96]` | `True` | `True` | `True` |
| `pingpong` | `256` | `[32, 64, 64, 96]` | `True` | `True` | `True` |
