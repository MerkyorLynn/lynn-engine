...
| `r5c4_full_active_moe_prefill_speed_ab` | **READY_WAITING_R6000** | summary tooling exists, but no R5-C4 speed result.json artifact is banked | `scripts/stage6_r5c4_candidate_metrics_template.json, scripts/stage6_r5c4_candidate_from_metrics.py, scripts/r6000_stage6_r5c4_full_active_moe_speed_ab.py, scripts/r6000_stage6_r5c4_full_active_moe_speed_ab.sh, scripts/summarize_stage6_r5c4_full_active_moe_speed_ab.py, scripts/test_stage6_r5c4_candidate_from_metrics.py, scripts/test_stage6_r5c4_full_active_moe_speed_ab_tools.py, scripts/test_stage6_r5c4_full_active_moe_speed_ab_validator.py` | Run the R5-C4 R6000 speed A/B harness; bank only active-MoE prefill speed, not decode/server/default. |
