...
| Note | Spark reachable via dgx-via-ssh; P4C gate/up shape sweep banked tile_inter=2 threads=128 as actionable diagnostic. Fused speed/default promotion still closed. |
