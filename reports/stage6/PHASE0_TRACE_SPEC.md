...
| P2-F one-layer opt-in replacement | Move P2-E from harness composition into a flag-gated one-layer prefill path | compare against `stream_bf16`, BF16 full MoE, memory, and token/numeric agreement |
