...
| P2-E scheduler / active retune | Reduce eager route/grouping overhead and packed active latency exposed by P2-D | numeric vs BF16 + stream oracle, no MoE BF16 shadow, peak near selected-expert scratch, latency beats stream and moves toward BF16 |
