...
| R6000 FP4-MMA bring-up | tooling ready,not banked yet:use any available RTX PRO 6000 96GB with >=500GB free disk,prefer 800GB-1TB expandable disk;gate checks CUDA/PyTorch/disk,public Marlin/Machete/CUTLASS visibility,and P76/P79/P85/P87/P103 native FP4 contracts |
...
31. **R6000 FP4-MMA bring-up gate:已 ready,等待机器实跑。** 选可租到的 RTX PRO 6000 96GB,磁盘 **>=500GB free**,优先 **800GB-1TB 可扩容**;第一条命令是 `scripts/r6000_stage6_fp4_mma_census.py --run-contracts`,PASS 前不写新 FP4-MMA kernel。
