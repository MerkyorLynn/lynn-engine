...
export LYNN_NATIVE_GATEUP_BACKEND="${LYNN_NATIVE_GATEUP_BACKEND:-triton_fast_decode}"
...
export LYNN_DECODE_FAST_DISPATCH="${LYNN_DECODE_FAST_DISPATCH:-1}"
export LYNN_ROUTER_TOPK_OUT_BUFFER="${LYNN_ROUTER_TOPK_OUT_BUFFER:-1}"
