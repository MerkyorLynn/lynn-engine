...
export LYNN_PACKED_DECODE="${LYNN_PACKED_DECODE:-1}"
export LYNN_PACKED_DECODE_BACKEND="${LYNN_PACKED_DECODE_BACKEND:-native_fast_2d}"
export LYNN_PACKED_DECODE_FULL_ATTN="${LYNN_PACKED_DECODE_FULL_ATTN:-1}"
export LYNN_PACKED_DECODE_LINEAR_ATTN="${LYNN_PACKED_DECODE_LINEAR_ATTN:-1}"
export LYNN_PACKED_SHARED_EXPERT="${LYNN_PACKED_SHARED_EXPERT:-1}"
