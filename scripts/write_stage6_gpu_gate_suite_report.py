...
def write_report(suite_dir: Path, *, report_date: str) -> str:
    ...
    decision = (
        "Use child P2-O/P3-A/P3-B/P3-C/P3-D reports to decide what can be banked; this suite report only aggregates evidence."
        if verdict == "PASS"
    ...
    lines.extend([
        ...
        decision,
        "",
        "A PASS here is orchestration-level evidence only. P2-O, P3-A, P3-B, P3-C, and P3-D must still",
