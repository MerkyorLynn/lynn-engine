...
MODEL_DIR="${MODEL_DIR:-/root/autodl-tmp/models/Qwen3.6-35B-A3B-BF16}"
P133_FIXTURES="${P133_FIXTURES:-${REPO_DIR}/reports/qwen36_35b/p133_fixtures}"
P135_OUT="${REPO_DIR}/reports/qwen36_35b/p135_repacked_fixtures"
...
python -m py_compile benchmarks/p135_repack_moe_fixture_slots.py
echo "  p135: OK"
python -m py_compile benchmarks/p136_moe_slot_repack_contract.py
echo "  p136: OK"
echo ""
