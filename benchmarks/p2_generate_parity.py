#!/usr/bin/env python3
"""P2-D gate: minimal greedy generation parity between BF16 and NVFP4.

This gate exercises the full 40-layer brute-force greedy loop, not just prefill
logits. It compares the generated token IDs from a BF16 oracle and the NVFP4
v8-RTN slow-dequant path for the same prompt.
"""
...
def main() -> int:
    ...
    result = {
        "schema_version": "lynn-engine-p2-generate-parity-v1",
        "prompt": args.prompt,
