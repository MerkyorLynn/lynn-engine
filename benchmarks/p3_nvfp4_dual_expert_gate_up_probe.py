...
def main() -> int:
    ...
    separate_up = up(x)
    runtime_gate, runtime_up = dual_scalar_bridge(x, gate, up)
    ...
    result: dict[str, Any] = {
        ...
        "comparisons": {
            ...
            "gate_runtime_dual_vs_separate": _compare(runtime_gate, separate_gate),
            "up_runtime_dual_vs_separate": _compare(runtime_up, separate_up),
        },
        "timing_ms": {
